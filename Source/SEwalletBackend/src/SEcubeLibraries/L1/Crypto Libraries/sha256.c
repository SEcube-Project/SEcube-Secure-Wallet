/**
  ******************************************************************************
  * File Name          : sha256.c
  * Description        : Low level SHA-256 implementation.
  ******************************************************************************
  *
...
#include "../../../SEcubeLibraries/L1/Crypto Libraries/sha256.h"
...
/*
void B5_SHA256_R(uint32_t t, B5_tSha256Ctx* ctx) {
    ctx->W[t] = B5_SHA256_S1(ctx->W[t -  2]) + ctx->W[t -  7] + B5_SHA256_S0(ctx->W[t - 15]) + ctx->W[t - 16];
}*/
