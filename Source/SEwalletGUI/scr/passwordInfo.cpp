 ...
 * Constructor
 */
passwordInfo::passwordInfo(QWidget *parent) : QDialog(parent), ui(new Ui::zxcInfo) {
    ui->setupUi(this);
}
 ...
 * Constructor
 */
passwordInfo::passwordInfo(QWidget *parent, QStandardItemModel* model, QStandardItemModel *model_whole, QStandardItemModel* model_multi, QStandardItemModel *model_times) : QDialog(parent), ui(new Ui::zxcInfo) {
    ui->setupUi(this);
    setModal(true);
