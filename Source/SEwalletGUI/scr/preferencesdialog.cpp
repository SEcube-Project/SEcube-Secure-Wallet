...
PreferencesDialog::PreferencesDialog(QWidget *parent) : QDialog(parent), ui(new Ui::PreferencesDialog) {
    ui->setupUi(this);
    setWindowTitle( tr("SEwallet Settings") );
 ...
 *
 * @brief PreferencesDialog::on_cb_gens_currentIndexChanged
 * @param index
 */
...
/* As qcheckbox text cannot be wrapped, a textless checkbox plus a label was used.
 * When the label is clicked the correspondent checkbox is togled */
 ...
 *
 * @brief PreferencesDialog::on_pb_chDirPhra_clicked
 */
void PreferencesDialog::on_pb_chDirPhra_clicked() {

    QString zxcvbn_path = QCoreApplication::applicationDirPath().append("/../../SEwalletGUI/zxcvbn/");//just a recomended directory
    qDebug() << "PATH_SELECTED: "<< zxcvbn_path;
 ...
 *
 * @brief PreferencesDialog::on_pb_chDicPhra_clicked
 */
 ...
 *
 * @brief PreferencesDialog::on_pb_applyPhra_clicked
 */
...
void PreferencesDialog::on_pb_genGen_clicked(){
    ...
    QProcess sh;
    QString zxcvbn_make_path = QCoreApplication::applicationDirPath().append("/../../SEwalletGUI/zxcvbn/");
    qDebug() << "PATH_SELECTED: "<< zxcvbn_make_path;
...
/**
 * @brief PreferencesDialog::on_pb_genChoose_clicked
 */
...
/**
 * @brief PreferencesDialog::on_pb_genClean_clicked
 */
...
/**
 * @brief PreferencesDialog::setAllEnabled
 * @param enabled
 */
...
/**
 * @brief PreferencesDialog::on_pb_userBrowse_clicked
 */
...
/**
 * @brief PreferencesDialog::on_pb_userMan_clicked
 */
...
/**
 * @brief PreferencesDialog::on_pb_userCurrent_clicked
 */
