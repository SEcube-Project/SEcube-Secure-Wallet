 ...
 * Constructor
 */
editUserDict::editUserDict(QWidget *parent) : QDialog(parent), ui(new Ui::editUserDict) {
    ui->setupUi(this);
 ...
 * Constructor
 */
editUserDict::editUserDict(QWidget *parent, QString fileName) : QDialog(parent), ui(new Ui::editUserDict) {
    ui->setupUi(this);
